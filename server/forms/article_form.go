...
type ArticleAddForm struct {
	...
	Content          string `json:"content" binding:"required,max=100000" label:"渲染后内容"`          // 渲染后内容
	MDContent        string `json:"md_content" binding:"required,max=1000000" label:"Markdown内容"` // Markdown内容
...
type ArticleEditForm struct {
	...
	Summary          string `json:"summary" binding:"max=255" label:"摘要"`                        // 摘要
	Img              string `json:"img" binding:"max=255" label:"图片"`                            // 图片
	Content          string `json:"content" binding:"required" label:"渲染后内容"`                    //  渲染后内容
	MDContent        string `json:"md_content" binding:"required,max=100000" label:"Markdown内容"` // Markdown内容
	Keywords         string `json:"keywords" label:"SEO 关键词"`                                    // SEO 关键词
}
